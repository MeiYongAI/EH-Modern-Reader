(function() {
  ...
  const zh = {
    ...
    appDescription: '面向 E-Hentai、ExHentai、nhentai 和 hitomi.la 的多站点阅读器。',
    backToGallery: '返回画廊',
    loadingTitle: '加载中...',
    loading: '加载中',
    page: '第 {page} 页',
    ...
    welcomeSubtitle: '多站点阅读器（E-Hentai / ExHentai / nhentai / hitomi.la）',
    ...
    hitomiNote: 'hitomi.la 现在会接管原生 Read Online 入口，并修正图片 CDN 路由。',
  ...
  const en = {
    ...
    appDescription: 'A multi-site reader for E-Hentai, ExHentai, nhentai, and hitomi.la.',
    ...
    welcomeSubtitle: 'Multi-site reader (E-Hentai / ExHentai / nhentai / hitomi.la)',
    openE: 'E-Hentai',
    openEx: 'ExHentai',
    openNh: 'nhentai.net',
    openHitomi: 'hitomi.la',
    ...
    hitomiNote: 'hitomi.la now takes over the native Read Online entry and uses corrected image CDN routing.',
